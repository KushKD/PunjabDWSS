...
$(document).ready(
	...
	function de_forward() {
		...
		if (result) {
			document.sendMonthlyReportForm.action = "sendMonthlyReportAction.do?method=save&d__mode="
					+ d__mode + "&menuId=CQ009";
	...
	function de_find() {
		...
		//var status = validateFields();
		if (result) {
			document.sendMonthlyReportForm.action = "sendMonthlyReportAction.do?method=find&d__mode="
					+ d__mode + "&menuId=CQ009";
			document.sendMonthlyReportForm.submit();
		}
	}
...
<html:form action="sendMonthlyReportAction" method="post"
	styleId="sendMonthlyReportForm" enctype="multipart/form-data">
	...
	<div class="panel panel-danger">
		<div class="panel-body">
			...
			<div class="form-inline col-lg-4 col-md-5 sm-hidden xs-hidden">
				<label class="text-left labledesign"><bean:message
						bundle="construction" key="upload.report" /><span
					class="text-danger"> &nbsp;*</span> </label>
				<html:file property="progressFile" styleId="progressFile"
...
<div class="col-lg-4 col-md-5 sm-hidden xs-hidden">&nbsp;
			...
			<div class="col-lg-2 col-md-2 sm-hidden xs-hidden">&nbsp;
				&nbsp;</div>
			<div class="col-lg-2 col-md-2 sm-hidden xs-hidden">&nbsp;
				&nbsp;</div><div class="col-lg-2 col-md-2 sm-hidden xs-hidden">&nbsp;
				&nbsp;</div>
			<div class="col-lg-2 col-md-2 sm-hidden xs-hidden">&nbsp;
				&nbsp;</div>
			<div class="col-lg-2 col-md-2 sm-hidden xs-hidden">&nbsp;
			...
			<div class="col-lg-2 col-md-2 sm-hidden xs-hidden">&nbsp;
				&nbsp;</div>
			<div class="col-lg-10 col-md-10 sm-hidden xs-hidden" style='max-width:1000px'>
		...
		<div class="panel-body">
			...
			<div class=" form-inline col-lg-8 col-md-8 col-xs-12 col-sm-6">
				...
				<html:textarea property='postImplemetation'
					styleId='postImplementation' styleClass="form-control ci5"
					style="width: 500px;">
				</html:textarea>
			</div>
	...
	<div
				...
				class=" form-inline col-lg-2 col-md-2 col-xs-hidden col-sm-hidden">&nbsp;</div>
				<div
				class=" form-inline col-lg-1 col-md-2 col-xs-hidden col-sm-hidden">&nbsp;</div>
	<div class="col-lg-4 col-md-5 sm-hidden xs-hidden">
				<button type="button" class="btn btn-primary" style="width: 150px;"
					onclick="de_forward()">Forward</button>
			</div>
			<div
				class=" form-inline col-lg-4 col-md-5 col-xs-hidden col-sm-hidden">&nbsp;</div>
				<div
				class=" form-inline col-lg-2 col-md-2 col-xs-hidden col-sm-hidden">&nbsp;</div>
</html:form>
