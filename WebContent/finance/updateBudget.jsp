...
<script type="text/javascript">
	...
	function de_modify() {
		...
		if (result) {
			if (validateQuarter()) {
				document.divisionBudgetForm.action = "updateBudgetAction.do?method=update&d__mode="
		...
		<script type="text/javascript">
			...
			if (text != "") {
				...
				ctx=re.exec(window.location.href);
					window.location.href = ctx+'nodalDivisionBudgetViewAction.do?menuId=FN008';
			}
		</script>
</logic:messagesPresent>

<html:form action="updateBudgetAction" method="post"
			...
			<div class=" form-inline col-lg-4 col-md-5 col-xs-12 col-sm-6">
				...
				<html:select property="subSubComponent" styleId="subSubComponent"
					...
					onchange="ajaxFunction(
								...
								'subSubComponentLevel3');ajaxFunction(
	...
	$(document)
			.ready(
					function() {
						...
						document.getElementById('division').value = localStorage
								.getItem("divisionId");
