...
<script type="text/javascript">
	...
	function de_filePDF() {
		...
		if (inList(periodReport, listIBRDProgMgt)) {
			...
			document.getElementById("fromDate").value = "01-04-2008"; //1
	...
	function de_file_period() {
		...
		if (document.getElementById("selectPeriod_s_period").checked) {
			...
			document.getElementById("fromDate").value = (fromDate_pop == null
					|| fromDate_pop == '' || fromDate_pop == undefined) ? '01-04-2008'  //2
					: fromDate_pop;
			...
			document.getElementById("fromDate").value = (fromDate_pop3 == null
					|| fromDate_pop3 == '' || fromDate_pop3 == undefined) ? '01-04-2008'  //3
					: fromDate_pop3;
			document.getElementById("toDate").value = (toDate_pop3 == null
					|| toDate_pop3 == '' || toDate_pop3 == undefined) ? today
					: toDate_pop3;
		} else {
			document.getElementById("fromDate").value = "01-04-2008";  //4
			document.getElementById("toDate").value = today;
		}
	...
	function de_file_periodSwap() {
		...
		if (document.getElementById("selectPeriod_s_period1").checked) {
			var fromDate_pop = document.getElementById("fromDate_pop1").value;
             alert(fromDate_pop);
             console.log(fromDate_pop);
			var toDate_pop = document.getElementById("toDate_pop1").value;
			document.getElementById("fromDate").value = (fromDate_pop == null
					|| fromDate_pop == '' || fromDate_pop == undefined) ? '01-04-2008'  //5
					: fromDate_pop;
			document.getElementById("toDate").value = (toDate_pop == null
					|| toDate_pop == '' || toDate_pop == undefined) ? today
					: toDate_pop;
			...
			document.getElementById("fromDate").value = (fromDate_pop == null
					|| fromDate_pop == '' || fromDate_pop == undefined) ? '01-04-2008'   //6
					: fromDate_pop;
			document.getElementById("toDate").value = (toDate_pop == null
					|| toDate_pop == '' || toDate_pop == undefined) ? today
					: toDate_pop;
		} else {
			document.getElementById("fromDate").value = "01-04-2008";   //7
			document.getElementById("toDate").value = today;
		}
		document.estimatesAwardContractsReportForm.action = "estimatesAwardContractsReportAction.do?method="
				+ (isPDF ? "filePDF" : "fileExcel")
	...
	function de_file_periodSwapC() {
		...
		if (document.getElementById("selectPeriod_s_period9").checked) {
			...
			document.getElementById("fromDate").value = (fromDate_pop == null
					|| fromDate_pop == '' || fromDate_pop == undefined) ? '01-01-1950'  //8
					: fromDate_pop;
			document.getElementById("toDate").value = (toDate_pop == null
					|| toDate_pop == '' || toDate_pop == undefined) ? today
					: toDate_pop;
		} else {
			document.getElementById("fromDate").value = "01-01-1950";  //9
			document.getElementById("toDate").value = today;
		}
		document.estimatesAwardContractsReportForm.action = "estimatesAwardContractsReportAction.do?method="
				+ (isPDF ? "filePDF" : "fileExcel")
	...
	function de_fileExcel() {
		...
		if (inList(periodReport, listIBRDProgMgt)) {
			...
			document.getElementById("fromDate").value = "01-04-2008";  //10
			document.getElementById("toDate").value = today;
	...
	function disable_enable(ele) {
		...
		var select = [ 'swap_nonswap_abstract', 'swap_nonswap_detail',
				'prwss_abstract','prwss_abstract1', 'prwss_detail', 'program_management',
				'beneficiary_share', 'progress_monitoring_dtl',
				'rslt_indicator', 'infra_structure_develop', 'data_monitoring',
				'phy_fin_monitoring', 'prwssip_abstract', 'prwssip_detail','prwss_performa' ];
	...
	function habitationDataReport() {
		...
		var prwss_performa = document.getElementById("prwss_performa").value;
		...
		if(prwss_performa=="PMMRPT001_200" && document.getElementById("selectReport18").checked){
			
			if (rptDisp == "ALL")
				val = "PMMRPT001_200";
			if (rptDisp == "BW")
				val = "PMMRPT001_200";//need to change
			if (rptDisp == "CNW")
				val = "PMMRPT001_200";//need to change
			if (rptDisp == "DW")
				val = "PMMRPT001_200";//need to change
		}
	if(prwss_performa=="PMMRPT001_201" && document.getElementById("selectReport18").checked){
				
				if (rptDisp == "ALL")
					val = "PMMRPT001_201";
				if (rptDisp == "BW")
					val = "PMMRPT001_201";//need to change
				if (rptDisp == "CNW")
					val = "PMMRPT001_201";//need to change
				if (rptDisp == "DW")
					val = "PMMRPT001_201";//need to change
			}
	if(prwss_performa=="PMMRPT001_202" && document.getElementById("selectReport18").checked){
		
		if (rptDisp == "ALL")
			val = "PMMRPT001_202";
		if (rptDisp == "BW")
			val = "PMMRPT001_202";//need to change
		if (rptDisp == "CNW")
			val = "PMMRPT001_202";//need to change
		if (rptDisp == "DW")
			val = "PMMRPT001_202";//need to change
	}
	if(prwss_performa=="PMMRPT001_203" && document.getElementById("selectReport18").checked){
		
		if (rptDisp == "ALL")
			val = "PMMRPT001_203";
		if (rptDisp == "BW")
			val = "PMMRPT001_203";//need to change
		if (rptDisp == "CNW")
			val = "PMMRPT001_203";//need to change
		if (rptDisp == "DW")
			val = "PMMRPT001_203";//need to change
	}
	if(prwss_performa=="PMMRPT001_204" && document.getElementById("selectReport18").checked){
		
		if (rptDisp == "ALL")
			val = "PMMRPT001_204";
		if (rptDisp == "BW")
			val = "PMMRPT001_204";//need to change
		if (rptDisp == "CNW")
			val = "PMMRPT001_204";//need to change
		if (rptDisp == "DW")
			val = "PMMRPT001_204";//need to change
	}
	if(prwss_performa=="PMMRPT001_205" && document.getElementById("selectReport18").checked){
		
		if (rptDisp == "ALL")
			val = "PMMRPT001_205";
		if (rptDisp == "BW")
			val = "PMMRPT001_205";//need to change
		if (rptDisp == "CNW")
			val = "PMMRPT001_205";//need to change
		if (rptDisp == "DW")
			val = "PMMRPT001_205";//need to change
	...
	//PMMRPT001_205
		...
		if (prwss_abstract == "HSPWA_3"
			&& document.getElementById("selectReport3").checked) {
		if (rptDisp == "ALL")
			val = "WATER3";
		if (rptDisp == "BW")
			val = "WATER3";//need to change
		if (rptDisp == "CNW")
			val = "WATER3";//need to change
		if (rptDisp == "DW")
			val = "WATER3";//need to change
		...
		if (prwss_abstract == "HSPWA_4"
			&& document.getElementById("selectReport3").checked) {
		if (rptDisp == "ALL")
			val = "WATER4";
		if (rptDisp == "BW")
			val = "WATER4";//need to change
		if (rptDisp == "CNW")
			val = "WATER4";//need to change
		if (rptDisp == "DW")
			val = "WATER4";//need to change
	...
	<html:form action="estimatesAwardContractsReportAction"
		...
		<div class="panel-body">
			<h4
				...
				Water Quality Reports</h4>
			
			
			<div class="col-lg-2 col-md-1 sm-hidden xs-hidden">&nbsp;
				&nbsp;</div>
			<div class=" form-inline col-lg-4 col-md-5 col-xs-12 col-sm-6">
				<html:radio property="selectReport"
								value="prwss_abstract"
								onclick="disable_enable('prwss_abstract');"
								styleId="selectReport3"> Abstracts</html:radio>
			</div>

			<div class=" form-inline col-lg-4 col-md-5 col-xs-12 col-sm-6">
				<select id="prwss_abstract" class="cs3"
							onchange="document.getElementById('selectReport3').value = habitationDataReport();disable_enable('prwss_abstract');">
								<option value="">Select Report</option>
								 <option value="HSPWA_2">All Metal Report</option>
								<option value="HSPWA_1">District Test Report</option>
									<option value="HSPWA_3">Heavy Metal Report</option>
										<option value="HSPWA_4">Basic Metal Report</option>
										<!-- <option value="HSPWA_4">Multiplying Factor Report </option> -->
			...
			<div style="visibility: collapse;">
						...
						<html:radio property="selectReport" value="prwss_detail"
								onclick="disable_enable('prwss_detail');"
								styleId="selectReport4"> Details</html:radio>
						<select id="prwss_detail" class="cs3"
			...
			<div style="visibility: collapse;">
					...
					<%@include file="../../JSPF/pmmReportConversation.jspf"%>
						...
						Please Select Report Format
						
						<select id="ABCD" style="width: 255px" styleClass="ci5"
							onChange="
						...
						Scheme Type
						<select id="schemeType" style="width: 255px"
							class="ci5"
							onChange="
											document.getElementById('selectReport5').value = habitationDataReport();
											">
			...
			<div style="visibility: collapse;">
				<html:radio property="selectReport"
								...
								styleId="selectReport1"> Abstracts</html:radio>
						<select id="swap_nonswap_abstract" class="cs3"
						...
						<html:radio property="selectReport"
								...
								styleId="selectReport2"> Details</html:radio>
						<select id="swap_nonswap_detail" class="cs3"
			...
			<div style="visibility: collapse;">
				<html:radio property="selectReport"
								...
								styleId="selectReport5">A. Program Management</html:radio>
						<select id="program_management" class="cs3"
						...
						<html:radio property="selectReport"
								...
								styleId="selectReport6">B. Beneficiary Share Collection</html:radio>
						<select id="beneficiary_share" class="cs3"
						...
						<html:radio property="selectReport"
								...
								styleId="selectReport7">C. Progress Monitoring (Details)</html:radio>
						<select id="progress_monitoring_dtl" class="cs3"
						...
						<html:radio property="selectReport"
								...
								styleId="selectReport8">D. Result Indicator(Community Development)</html:radio>
						<select id="rslt_indicator" class="cs3"
						...
						<html:radio property="selectReport"
								...
								styleId="selectReport9">E.ResultIndicator(Infrastructure Development)</html:radio>
						<select id="infra_structure_develop" class="cs3"
							...
							style="width: 250px">
								...
								<option value="PMMRPT001_16">E.1.2 Table-4b: For
									schemes implemented under IDA SWAp</option>
						</select><html:radio property="selectReport"
								value="data_monitoring"
								onclick="disable_enable('data_monitoring');"
								styleId="selectReport10">F. Data Entry Monitoring Report</html:radio><select id="data_monitoring" class="cs3"
						...
						<html:radio property="selectReport"
								...
								styleId="selectReport11">G. Physical/Financial Monitoring Report</html:radio>
						<select id="phy_fin_monitoring" class="cs3"
						...
						Select Program <html:radio property="selectProgram"
						...
						Period
						<html:radio property="selectPeriod" title="Selection"
								value="S" styleId="selectPeriod_ida_s">Selection</html:radio> <html:radio
								property="selectPeriod" title="All" value="All"
								styleId="selectPeriod_ida_s">All</html:radio>
						From:&nbsp;&nbsp;&nbsp; <html:text property="IDAType"
						...
						<html:radio property="selectPeriod" title="Selection"
								...
								property="selectPeriod" title="All" value="All"
								styleId="selectPeriod_SM_s">All</html:radio>
					From:&nbsp;&nbsp;&nbsp; <html:text property="SMType"
						...
						<html:radio property="selectPeriod" title="Selection"
								...
								property="selectPeriod" title="All" value="All"
								styleId="selectPeriod_IA3_s">All</html:radio>
						From:&nbsp;&nbsp;&nbsp; <html:text property="IDA5"
						...
						<html:radio property="selectPeriod" title="Selection"
								...
								property="selectPeriod" title="All" value="All"
								styleId="selectPeriod_TSc_a">All</html:radio>
						<html:text property="yearType" styleId="yearType"
								styleClass="ci3"></html:text>
						<%-- <td>
					<html:text property="schemeTypeRRR" styleId="schemeTypeRRR"	styleClass="ci3"></html:text> 
				</td> --%>

					
						 <html:radio property="selectPeriod"
						...
						From:&nbsp;&nbsp;&nbsp; <html:text property="fromDate"
			...
			<div style="visibility: collapse;">
				<html:radio property="selectReport"
								...
								styleId="selectReport12"> Abstracts</html:radio>
						<select id="prwssip_abstract" class="cs3"
						...
						<html:radio property="selectReport"
								...
								styleId="selectReport13"> Details</html:radio>
						<select id="prwssip_detail" class="cs3"
			...
			<div style="visibility: collapse;">
				<html:radio property="selectReport"
								value="prwss_performa"
								onclick="disable_enable('prwss_performa');"
								styleId="selectReport18"> Performa Report</html:radio>
						<select id="prwss_performa" class="cs3"
							onchange="document.getElementById('selectReport18').value = habitationDataReport();disable_enable('prwss_performa');">
								<option value="">Select Report</option>
								 <option value="PMMRPT001_200">Five Year Action Plan : Part-1</option>
								 <option value="PMMRPT001_201">Five Year Action Plan : Part-2</option>
								 <option value="PMMRPT001_202">Five Year Action Plan : Part-3</option>
								 <option value="PMMRPT001_203">Five Year Action Plan : Part-4</option>
								 <option value="PMMRPT001_204">Five Year Action Plan : Part-5</option>
								 <option value="PMMRPT001_205">Five Year Action Plan : Part-6</option>
						</select></div>
