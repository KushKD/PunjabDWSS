		...
		<c:if test="${not empty beneficiaryDto}">
			<div class="panel panel-danger" id="revalidate">
				<div class="panel-body">
					...
					<div class=" form-inline col-lg-11 col-md-5 col-xs-12 col-sm-12">
						<div class="table-responsive">
							<table class="table table-bordered table-striped table-highlight"
								id="surveyTable" style='display: block;'>
								<thead style='display: block;' class='thead-dark'>
									<tr class="row">
										<th class='col-xs-1' style='width: 9.899999995%'>Name</th>
										<th class='col-xs-2' style='width: 14.2%'>Father/Husband
											Name</th>
										<th class='col-xs-2' style='width: 13.3%'>Electric
											Connection No</th>
										<th class='col-xs-2' style='width: 13.8%'>Aadhar Card
											Number</th>
										<th class='col-xs-2' style='width: 13.5%'>Current Status</th>
										<th class='col-xs-2' style='width: 13.9%'>Update status</th>
										<th class='col-xs-2' style='width: 18.8%'>Remarks</th>
										<th class='col-xs-1' style='width: 9.899999995%'><input
										...
										<tr class="row">
											...
											<td class='col-xs-2' style='width: 14.499999995%'>
												<div class='form-inline'>
													...
													indexed="true" />
											<td class='col-xs-1'><html:checkbox
											...
											<thead style='display: block;' class='thead-dark'>
												<tr class="row">
													...
													<th class='col-xs-2' style='width: 14.5%'>Aadhar Card
														Number</th>
													<th class='col-xs-2' style='width: 14.8%'>Updated
														Status</th>
