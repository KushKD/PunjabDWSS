		...
		<div class="panel-body">
			...
			<div id='urban_rural'>
				...
				<div class=" form-inline col-lg-2 col-md-5 col-xs-12 col-sm-6">
						<html:radio  property="office" value="1" styleId="hoffice" onclick="hofficeselection();" ><bean:message
						bundle="RTI" key="head.office" /></html:radio>
				</div>

				<div class=" form-inline col-lg-2 col-md-5 col-xs-12 col-sm-6">
						<html:radio property="office" value="2" styleId="foffice" onclick="fofficeselection();"><bean:message
						bundle="RTI" key="field.office" /></html:radio>
				</div>
	...
	<div class="row">
			...
			<div class="col-lg-1 col-md-1 sm-hidden xs-hidden">&nbsp;</div>
				<div class=" form-inline col-lg-8 col-md-5 col-xs-12 col-sm-6" >
					...
					<html:checkbox property='poverty' styleId='poverty' value="1" onclick="belowpoverty();"><bean:message
						bundle="RTI" key="applicant.bpl" /></html:checkbox> &nbsp; &nbsp; &nbsp;
					</div>
			</div>
	</div>
	</div>
	...
	<div class="panel panel-danger">
		<div class="panel-body">
			...
			<div class="col-lg-2 col-md-1 sm-hidden xs-hidden">&nbsp;
				...
				<div class=" form-inline col-lg-8 col-md-5 col-xs-12 col-sm-6">
					<label class="text-right labledesign"><bean:message
						bundle="RTI" key="rti.details" /><span
						class="text-danger"> &nbsp;*</span></label>
			...
			<div class="col-lg-2 col-md-1 sm-hidden xs-hidden">&nbsp;
				...
				<div class=" form-inline col-lg-8 col-md-5 col-xs-12 col-sm-6">
					<label class="text-right labledesign"><bean:message
						bundle="RTI" key="rti.application" /></label>
			...
			<div class="col-lg-2 col-md-1 sm-hidden xs-hidden">&nbsp;
				...
				<div class=" form-inline col-lg-8 col-md-5 col-xs-12 col-sm-6">
					<label class="text-right labledesign"><bean:message
						bundle="RTI" key="supporting.doc" /></label>
	...
	<div id="paymentsection" class="panel panel-danger">
		<div class="panel-body">
			...
			<div class="row">
				...
				<div class=" form-inline col-lg-4 col-md-5 col-xs-12 col-sm-6">
				<label class="text-right labledesign"><bean:message
						bundle="RTI" key="pay.date" /></label> <html:text
					property="datePayment" style="width: 150px" styleId="datePayment"
			...
			<div class="row">
				...
				<div class=" form-inline col-lg-4 col-md-5 col-xs-12 col-sm-6">
					<label class="text-right labledesign"><bean:message
						bundle="RTI" key="pay.amount" /></label>
			...
			<div class=" form-inline col-lg-4 col-md-5 col-xs-12 col-sm-6">
					<label class="text-right labledesign"><bean:message
						bundle="RTI" key="ref.number" /></label>
